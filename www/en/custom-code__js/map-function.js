...
var stateName_DB_order = [jQuery('#NSW-light'), jQuery('#VIC-light'), jQuery('#QLD-light'), jQuery('#SA-light'), jQuery('#NT-light'), jQuery('#WA-light'), jQuery('#ACT-light'), jQuery('#TAS-light'), jQuery('#NZ_North-light, #NZ_South-light')];
var stateTxt_DB_order = [jQuery('#NSW_txt'), jQuery('#VIC_txt'), jQuery('#QLD_txt'), jQuery('#SA_txt'), jQuery('#NT_txt'), jQuery('#WA_txt'), jQuery('#ACT_txt'), jQuery('#TAS_txt'), jQuery('#NZ_North_txt, #NZ_South_txt')];
var stateTxt_DB_order_Cn = [jQuery('#NSW_txt-cn'), jQuery('#VIC_txt-cn'), jQuery('#QLD_txt-cn'), jQuery('#SA_txt-cn'), jQuery('#NT_txt-cn'), jQuery('#WA_txt-cn'), jQuery('#ACT_txt-cn'), jQuery('#TAS_txt-cn'), jQuery('#NZ_North_txt-cn, #NZ_South_txt-cn')];
...
/**  =============== [Radio] =============== **/
jQuery('input[name="state"]').change(function(){
	
	var state_Radio = jQuery('input[name="state"]:checked').val();
	var index = state_Radio -1;
	...
	jQuery.each(stateAsset, function(index, value){
		...
		this.hover(function(){
			...
			if (jQuery('#mapBtn_Dark').hasClass('custom-mapState_button_Clicked')){
				...
				if (jQuery('input[name="state"]:checked').val() == null){
					stateToDark__init();
				}
				else{
					stateToDark__chosen();
...
function stateToDark__chosen() {
	...
	stateToDark__specific(jQuery('input[name="state"]:checked').val() -1);
	txtShow(jQuery('input[name="state"]:checked').val() -1);
