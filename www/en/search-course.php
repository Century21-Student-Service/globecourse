										...
										<form action="search-course__result" id="showResult" target="Result_Popup" onsubmit="ShowResult()" method="post">
											...
											<div class="gdlr-core-pbf-column gdlr-core-column-30">
															...
															<div
																...
																<div class="gdlr-core-title-item-title-wrap clearfix">
																	...
																	<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																		style="font-size: 34px ;font-weight: 700 ;letter-spacing: 0px ;text-transform: none ;color: #161616 ;">Course Search</h3>
																</div>
														...
														<div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
															<div class="gdlr-core-pbf-element">
																<div
																	...
																	<div class="gdlr-core-title-item-title-wrap clearfix">
																		<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																			style="font-size: 20px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Type of Courses
																		</h3>
																	</div>
																</div>
															</div>
															...
															<div class="gdlr-core-pbf-element">
																<div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix ">
																	<select name="schoolType" class="dropdown_100" id="schoolType">
																		<option value="0" id="">Please choose "Type of Course"</option>
																	</select>
																</div>
															</div>
													...
													<div class="gdlr-core-pbf-element">
														<div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix "
															...
															<label>
																...
																<div class="tab-box_2">
																	<div><span>Search by "Faculty"</span><br></div>
																</div>
															</label>
															...
															<label>
																...
																<div class="tab-box_2">
																	<div><span>Search by "Course Name"</span><br></div>
																</div>
															</label>
												...
												<div class="animated fadeIn" id="search_tab1_faculty">
													...
													<div class="gdlr-core-pbf-element">
														<div
															...
															<div class="gdlr-core-title-item-title-wrap clearfix">
																<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																	style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Faculty of Courses</h3>
															</div>
														</div>
													</div>
													...
													<div class="row ctm-disable" id="div_Major">
														...
														<div class="gdlr-core-pbf-element">
															<div
																...
																<div class="gdlr-core-title-item-title-wrap clearfix">
																	<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																		style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Major of Courses</h3>
																</div>
															</div>
														</div>
												...
												<div class="animated fadeIn tab-box__hide" id="search_tab2_faculty">
													...
													<div class="gdlr-core-pbf-element">
														<div
															...
															<div class="gdlr-core-title-item-title-wrap clearfix">
																<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																	style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Course Name</h3>
															</div>
												...
												<div class="gdlr-core-pbf-element" style="padding-left: 5%;">
													<button id="btnSearch" type="submit" class="gdlr-core-button gdlr-core-button-solid gdlr-core-button-no-border custom-button_noBorder"
														style="font-weight: bold;" id="button">Search</button>
	...
	<script type="text/javascript">
		...
		$("#schoolType").change(e => {
			...
			$.post('util/search-immigrationOperation?op=2', {
				...
				res = JSON.parse(res);
				allFields = res;
				$("#broadField").html(`<option value="0">Please choose "Faculty"</option>`);
				res.forEach(e => {
		...
		$("#broadField").change(e => {
			...
			$("#narrowField").html('<option value="0">Please choose "Major"</option>')
			allFields.forEach(f => {
				if (f.id == field_id_p)
