...
$dosql->Execute("select id, title_en, tag_en, image from course_hot order by sort desc, id desc");
while(1){
	$item = $dosql->GetArray();
	if($item == null) break;
...
<head>
    ...
    <title>Popular Courses | CT21 Search Platform</title>
                    ...
                    <div class="kingster-page-title-wrap  kingster-style-medium kingster-left-align" style="background-image: url(custom-images/home4_immigration_q1.jpg);" loading="lazy">  <!-- [Background-Image] -->
		                ...
		                <div class="kingster-page-title-container kingster-container">
		                    <div class="kingster-page-title-content kingster-item-pdlr ctm-header__content" style="height: 160px; padding-top: 55px !important; padding-bottom: 55px !important;">
		                    	...
		                    	<!-- ====================     << Title >>     ==================== -->
		                    	<h1 class="bold ctm-pgSchool__title" style="color: white; font-size: 40px; margin-bottom: 0; line-height: normal;">Popular Courses</h1>  <!-- (Chinese) -->
                                    ...
                                    <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-30" style="padding: 20px;" onclick="parent.location.href='http://www.ct21.com.cn/newsshow.php?cid=5&id=1132';">
                                            <div class="ctm-boxImg_wrapper" style="padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px #d1d1d1;">
                                                ...
                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="">
                                                    <h6 style="margin-top: 10px;">Double Advanced Diploma in Hotel Management and Exhibition Management, Paid Internship in Residence Hotel $145</h6>
                                                </div>
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-30" style="padding: 20px;" onclick="parent.location.href='http://www.ct21.com.cn/newsshow.php?cid=5&id=1204';">
                                            <div class="ctm-boxImg_wrapper" style="padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px #d1d1d1;">
                                                ...
                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="text-align: center;">
                                                    <div class="ctm-boxImg" style="object-fit: contain; width: 90% !important; height: 160px !important; border-radius: 10px; box-shadow: 0px 0px 10px #00000060; transition: all .2s ease; cursor: pointer; background-image: url(custom-logo/logo_Tafe_WSI.jpg); background-size: contain; background-repeat: no-repeat; background-position: center;" loading="lazy">
                                                            <div class="img_overlay"></div>
                                                            <div class="eleTitle">TAFE</div>
                                                        </div>
                                                </div>

                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="">
                                                    <h6 style="margin-top: 10px;">Ultra-low-cost Australian study and immigration shortcuts, preschool education, IT, accounting and other bachelor’s degree university courses 3-4 years total tuition is only AUD 43,000-57,000</h6>
                                                </div>
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-30" style="padding: 20px;" onclick="parent.location.href='http://www.ct21.com.cn/newsshow.php?cid=5&id=1132';">
                                            <div class="ctm-boxImg_wrapper" style="padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px #d1d1d1;">
                                                ...
                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="">
                                                    <h6 style="margin-top: 10px;">The value-for-money university preparatory course is only $13,596 a year</h6>
                                                </div>

                                            </div>
                                        </div>

                                        <div class="gdlr-core-pbf-column gdlr-core-column-30" style="padding: 20px;" onclick="parent.location.href='http://www.ct21.com.cn/newsshow.php?cid=52&id=1043';">
                                            <div class="ctm-boxImg_wrapper" style="padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px #d1d1d1;">
                                                ...
                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="text-align: center;">
                                                    <div class="ctm-boxImg" style="object-fit: contain; width: 90% !important; height: 160px !important; border-radius: 10px; box-shadow: 0px 0px 10px #00000060; transition: all .2s ease; cursor: pointer; background-image: url(custom-images/immi/immi_bachelor.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;" loading="lazy">
                                                            <div class="img_overlay"></div>
                                                            <div class="eleTitle">Undergraduate (Bachelor)</div>
                                                        </div>
                                                </div>

                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="">
                                                    <h6 style="margin-top: 10px;">The annual tuition for the Bachelor of IT and Accounting is only $16,800, and one year of paid internship opportunities for IT graduates</h6>
                                                </div>
                                        ...
                                        <div class="gdlr-core-pbf-column gdlr-core-column-30" style="padding: 20px;" onclick="parent.location.href='http://www.ct21.com.cn/newsshow.php?cid=53&id=1063';">
                                            <div class="ctm-boxImg_wrapper" style="padding: 20px; border-radius: 10px; box-shadow: 0px 0px 10px #d1d1d1;">
                                                ...
                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="text-align: center;">
                                                    <div class="ctm-boxImg" style="object-fit: contain; width: 90% !important; height: 160px !important; border-radius: 10px; box-shadow: 0px 0px 10px #00000060; transition: all .2s ease; cursor: pointer; background-image: url(custom-images/immi/immi_master.jpg); background-size: cover; background-repeat: no-repeat; background-position: center;" loading="lazy">
                                                            <div class="img_overlay"></div>
                                                            <div class="eleTitle">Master's Degree</div>
                                                        </div>
                                                </div>

                                                <div class="gdlr-core-pbf-column gdlr-core-column-30" style="">
                                                    <h6 style="margin-top: 10px;">The annual tuition for the IT and accounting master's program is only $17,800, and one year of paid internship opportunities for graduates of the IT master</h6>
                                                </div>
