...
?>
																		...
																		<div
																			...
																			<div class="gdlr-core-title-item-title-wrap clearfix">
																				...
																				<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																					style="font-size: 34px ;font-weight: 700 ;letter-spacing: 0px ;text-transform: none ;color: #161616 ;">Immigration
																					Search</h3>
																			</div>
																		</div>
																	</div>
																		...
																		<div class="gdlr-core-pbf-element">
																			<div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix "
																				...
																				<label>
																					...
																					<div class="tab-box_2">
																						<div><span>Non-Regional</span><br></div>
																					</div>
																				</label>
																				...
																				<div class="gdlr-core-pbf-element">
																					<div
																						...
																						<div class="gdlr-core-title-item-title-wrap clearfix">
																							<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																								style="font-size: 20px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">
																								<small>Type of Courses<small>(for immigration)</small></small></h3>
																						</div>
																					</div>
																				</div>
																		...
																		<div class="row ctm-disable" id="div_field">
																			<div class="gdlr-core-pbf-element">
																				<div
																					...
																					<div class="gdlr-core-title-item-title-wrap clearfix">
																						<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																							style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Faculty of
																							Courses</h3>
																					</div>
																				</div>
																			</div>
																		...
																		<div class="row ctm-disable" id="div_Major">
																			...
																			<div class="gdlr-core-pbf-element">
																				<div
																					...
																					<div class="gdlr-core-title-item-title-wrap clearfix">
																						<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																							style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Major of
																							Courses</h3>
																					</div>
																				</div>
																			</div>
																	...
																	<div class="animated fadeIn tab-box__hide" id="search_tab2">
																		...
																		<div class="gdlr-core-pbf-element">
																			<div
																				...
																				<div class="gdlr-core-title-item-title-wrap clearfix">
																					<h3 class="gdlr-core-title-item-title gdlr-core-skin-title "
																						style="font-size: 16px ;font-weight: 600 ;letter-spacing: 0px ;text-transform: none ;color: #464646 ;">Course Name
																					</h3>
																				</div>
																			</div>
																		</div>
		...
		$('#state').change(function () {
			...
			$.ajax({
				...
				success: function (ops) {
					var str = '';
					$("#schoolType").html(`<option value='0' selected='selected'>Please choose "Type of Courses"</option>`);
					for (var i in ops) {
	...
	<script>
		...
		$('#broadField').change(function (e) {
			...
			allFields.forEach(p => {
				if (p.id == field_p) {
					p.children.forEach(c => $("#narrowField").append(`<option value="${c.id}">${c.name}</option>`));
				}
			});
