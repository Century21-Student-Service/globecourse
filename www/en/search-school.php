...
<head>
    ...
    <style type="text/css">
        ...
        .ctm-subTitle{ font-size: 12px !important; font-style: normal !important; color: #6c6c6c; }
			                                ...
			                                <div class="gdlr-core-pbf-column gdlr-core-column-30">
			                                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js " style="margin: 0px 0px 20px 0px;padding: 0px 0px 0px 0px;">
			                                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js ">
			                                            ...
			                                            <!-- ====================     << Title >> {page}     ==================== -->
			                                            <?php pageTitle('School Search', '');  // title, subtitle ?>
			                                            <!-- ========================================     << (Blue) Line >>     ======================================== -->
			                                            <?php titleLine(); ?>
			                                            ...
			                                            <!-- ===== (State - 州) ===== -->
			                                            <?php sectionTitle('State', '');  // title, subtitle ?>
			                                            ...
			                                            <!-- ===== (Category - 课程类别) ===== -->
			                                            <?php sectionTitle('Type of Courses', '');  // title, subtitle ?>
