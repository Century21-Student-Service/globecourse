...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
		                            ...
		                            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
	                                        ...
	                                        <div class="gdlr-core-pbf-element">
	                                            <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix  gdlr-core-left-align gdlr-core-title-item-caption-bottom gdlr-core-item-pdlr">
	                                                <div class="gdlr-core-title-item-title-wrap clearfix">
	                                                    ...
	                                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title " style="font-size: 34px ;font-weight: 700 ;letter-spacing: 0px ;text-transform: none ;color: #161616 ;">留学方案</h3></div>
	                                                    <div><span class="gdlr-core-title-item-caption gdlr-core-info-font gdlr-core-skin-caption" style="font-size: 16px ;font-style: normal ;color: #6c6c6c ;margin-top: 0 ;">Study-Solution Search</span></div>
	                                            </div>
	                                        </div>
						                ...
						                <div class="container ctm-container">
						                    ...
						                    <div class="row ctm-tab" style="height: 120px;">
						                    	<div class="gdlr-core-column-15">
						                    		<div class="gdlr-core-column-20 stepItem stepActive" id="btnTab_1"><span>1</span><br>
						                    			<d>Choose "Current Education"</d></div>
						                    		<div class="gdlr-core-column-40"><spans class="stepLine"></spans></div>
						                    	</div>
						                    	<div class="gdlr-core-column-15">
						                    		<div class="gdlr-core-column-15" style="padding-right: 10px;"><spans class="stepLine"></spans></div>
						                    		<div class="gdlr-core-column-15 stepItem" id="btnTab_2"><span>2</span><br>
						                    			<d>Choose "Education to Enrol"</d></div>
						                    		<div class="gdlr-core-column-30" style="padding-left: 10px;"><spans class="stepLine"></spans></div>
						                    	</div>
						                    	<div class="gdlr-core-column-15">
						                    		<div class="gdlr-core-column-30" style="padding-right: 10px;"><spans class="stepLine"></spans></div>
						                    		<div class="gdlr-core-column-15 stepItem" id="btnTab_3"><span>3</span><br>
						                    			<d>Choose "State of Institution"</d></div>
						                    		<div class="gdlr-core-column-15" style="padding-left: 10px;"><spans class="stepLine"></spans></div>
						                    	</div>
						                    	<div class="gdlr-core-column-15">
						                    		<div class="gdlr-core-column-40"><spans class="stepLine"></spans></div>
						                    		<div class="gdlr-core-column-20 stepItem" id="btnTab_4"><span>4</span><br>
						                    			<d>Choose "Institution"</d></div>
						                    	</div>
						                    ...
						                    <div class="tab _inliner">
							                    ...
							                    <div style="padding: 20px 5px;">
							                    	<div class="gdlr-core-column-60 tabContent" style="display: none;" id="tab_2">
								                    	...
								                    	<div style="padding-bottom: 20px;"><span><strong>According to your educational background, we would like to suggest you the following study plans：</strong></span></div>
							                    		<div class="gdlr-core-pbf-element ctm-contentWrap">
			                                                <div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix ">
							                    ...
							                    <div class="wrapMap">
							                    	<div style="display: none;" id="tab_3">
								                    	...
								                    	<div class="gdlr-core-column-60 tabContent">
									                    	...
									                    	<div style="padding-bottom: 20px;"><span><strong>Please click on the map to select the state of the enrolling institutions：</strong></span></div>
									                    ...
									                    <div class="gdlr-core-column-60 tabContent">
									                    	...
									                    	<div style="padding-bottom: 20px;"><span><strong>According to your chosen state, we found the following institutions：</strong></span></div>
								                    		<div class="gdlr-core-pbf-element">
				                                                <div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix ">
						                    ...
						                    <div class="gdlr-core-pbf-element" style="display: inline; margin-left: 30px; border: 0px;">
                                            	<button class="gdlr-core-button gdlr-core-button-solid gdlr-core-button-no-border custom-button_noBorder" style="display: none; font-weight: bold;" id="btnBack">上 一 步</button>
                                                <!-- <input name="button" type="submit" class="" style="font-weight: bold;" id="button" value="立 即 搜 索"></div> -->
                                            </div>

						                    <!-- ====================     << Next-Step >>     ==================== -->
						                    <div class="gdlr-core-pbf-element" style="float: right; margin-right: 30px; border: 0px;">
                                            	<button class="gdlr-core-button gdlr-core-button-solid gdlr-core-button-no-border custom-button_noBorder ctm-btn_disable" style="font-weight: bold;" id="btnNext" onl>下 一 步</button>
                                                <!-- <input name="button" type="submit" class="" style="font-weight: bold;" id="button" value="立 即 搜 索"></div> -->
                                            </div>
	...
	<script type="text/javascript">
		btnNext_manageEvent();
		/** ====================  << (check) Step-1  >> ==================== **/
		jQuery('select[name="courseType"]').change(function(){
    		btnNext_manageEvent();
    	});

    	function btnNext_manageEvent(){
    		if (jQuery('#courseType').val() != 0){
    			jQuery('#btnNext').removeClass('ctm-btn_disable');
    		}
    		else
    			jQuery('#btnNext').addClass('ctm-btn_disable');
    	}
	</script>
    ...
    <script type="text/javascript">
    	...
    	var btnTab = [jQuery('#btnTab_1'), jQuery('#btnTab_2'), jQuery('#btnTab_3'), jQuery('#btnTab_4')];
    	var tContent = [jQuery('#tab_1'), jQuery('#tab_2'), jQuery('#tab_3'), jQuery('#tab_4')];
    	...
    	/** ====================  << Tab [click]  >> ==================== **/
    	// jQuery.each(btnTab, function(index, value){
    	// 	this.hover(function(){
    	// 		if (index < stepNum){
    	// 			btnTab[index].find('span').css({'color': 'white', 'background-color': '#027dfa82', 'transition': '.3s ease', 'cursor' : 'pointer'});
    	// 		}
    	// 	}, function(){
    	// 		btnTab[index].find('span').css({'color': '', 'background-color': '', 'cursor' : 'default'});
    	// 	});
    	...
    	jQuery('#btnNext').click(function(){
    		...
    		switch (stepNum){
    			...
    			case 1:{ // 「课程类别」
    				if (!jQuery('input:radio[name="solution"]').is(':checked') ){alert('请选择才能进去下一步');}
    				else{
    					selectedSolution = jQuery('input:radio[name="solution"]:checked').val();
    	...
    	function toPg_Next(){
    		...
    		jQuery('.tab').css({'transform' : 'translate('+pgNum+', 0)'});
    	...
    	function toPg_Back(){
    		...
    		jQuery('.tab').css({'transform' : 'translate('+pgNum_b+', 0)'});
    		tContent[stepNum-1].show();
    		tContent[stepNum].hide(400, "swing");
    		// jQuery('.tab').css({'transform' : 'translate(0%, 0)'}).animate({}, 300, function(){
		    //     jQuery('#tabContent_2').hide(400, "swing"); //alt $(this).slideUp(400);
		    // });
    	...
    	/** ====================  << AJax  >> ==================== **/
    	function getCType(){
    		// var tID = jQuery("#courseType").children("option:selected").val();
    		var solutionID = jQuery('#courseType').val();
    		jQuery.ajax({
				type :'GET',
				url  :'./../ext/ajaxFun.php?act=getStudySolution_cType_en&sType='+solutionID,
				date :'',
				success:function(m){
					jQuery('#radio_cType label').remove();
					jQuery('#radio_cType').append(m);
				}
			});
    	}
    	...
    	function getSchool(){
    		...
    		jQuery.ajax({
				...
				date :'',
				success:function(m){
					jQuery('#list_School h4').remove();
					jQuery('#list_School div').remove();
					jQuery('#list_School').append(m);

							// Add Fade In effect after img is loaded
							// jQuery('.ctm-nearbyUni__img').on('load', function(){
							// 	jQuery('.ctm-nearbyUni__img').addClass('animated fadeInUp');
							// });
							// var imgCount = jQuery('#list_School div').find('.ctm-nearbyUni__img');
							// alert(imgCount.length);
							// jQuery('#list_School').children().each(function(index){
							// 	// alert(jQuery(this).attr('value'));

					// Hide list after loaded
					jQuery('#list_School').children().hide();
					jQuery('#list_School h4').show();

					// Add Fade In effect to each div
					jQuery('#list_School div').addClass('animated fadeInUp');
					showDiv();

					function showDiv() {
						// If there are hidden divs left
					    if(jQuery('#list_School div:hidden').length) {
					        // Fade the first of them in
					        jQuery('#list_School div:hidden:first').show();
