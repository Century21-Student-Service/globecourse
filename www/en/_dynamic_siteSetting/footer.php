        ...
        <div class="kingster-footer-container kingster-container clearfix">
                ...
                <div id="text-2" class="widget widget_text kingster-widget">
                    <div class="textwidget">
                        ...
                        <p><a id="a_1dd7_8" href="mailto:info@ct21.com.au">E-mail：info@ct21.com.au</a>
                            ...
                            <br /> <span id="span_1dd7_11">Phone (Sydney)：(612) 9267 6047</span></p>
            ...
            <div class="kingster-footer-column kingster-item-pdlr kingster-column-15">
                <div id="gdlr-core-custom-menu-widget-4" class="widget widget_gdlr-core-custom-menu-widget kingster-widget">
                    <h3 class="kingster-widget-title">Quick Search</h3><span class="clear"></span>
                    <div class="menu-academics-container">
                        <ul id="menu-academics" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-plain">
                            <li class="menu-item"><a href="../en/search-course.php">Course Search</a></li>
                            <li class="menu-item"><a href="../en/search-school.php">School Search</a></li>
                            <li class="menu-item"><a href="../en/search-immigration.php">Immi. Search</a></li>
                            <li class="menu-item"><a href="../en/search-fees.php">Fees Search</a></li>
                        </ul>
                    </div>
                </div>
            </div>
