<style type="text/css">
    #menu-main-navigation-1 >li>a{ font-size: 14px !important; }
</style>
        ...
        <div class="kingster-top-bar-container-inner clearfix">
            ...
            <div class="kingster-top-bar-right kingster-item-pdlr">
                <ul id="kingster-top-bar-menu" class="sf-menu kingster-top-bar-menu kingster-top-bar-right-menu">
                    <li class="menu-item kingster-normal-menu"><a class="kingster-top-bar-right-button" style="font-weight: normal; cursor: auto;" target="_blank">Quick Link</a></li>
                    <li class="menu-item kingster-normal-menu"><a href="http://www.ct21.com.au/">CT21</a></li>
                    <li class="menu-item kingster-normal-menu"><a href="http://www.ct21.com.cn/"><small>(ct21)</small> Studying-Abroad</a></li>
                    <li class="menu-item kingster-normal-menu"><a href="http://www.ct21.cn"><small>(ct21)</small> Migration</a></li>
                    <li class="menu-item kingster-normal-menu"><a href="http://www.ct21investment.com/"><small>(ct21)</small> Investment</a></li>
                </ul>
            ...
            <div class="kingster-navigation kingster-item-pdlr clearfix ">
                <div class="kingster-main-menu" id="kingster-main-menu">
                    <ul id="menu-main-navigation-1" class="sf-menu">
                        ...
                        <!-- 1st Menu [button] -->
                        <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu <?php echo $class_Home; ?>"><a href="./../en/" class="sf-with-ul-pre">Home</a>
                            <!-- <ul class="sub-menu">
                        ...
                        <!-- 2nd Menu [button] -->
                        <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu <?php echo $class_studySolu; ?>"><a href="./../en/search-studySolution.php" class="sf-with-ul-pre">Study Plan</a></li>
                        <!-- 3rd Menu [button] -->
                        <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu <?php echo $class_Course; ?>"><a href="./../en/search-course.php" class="sf-with-ul-pre">Course Search</a>
                            <!-- <ul class="sub-menu">
                        ...
                        <!-- 4th Menu [button] -->
                        <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu <?php echo $class_School; ?>"><a href="./../en/search-school.php" class="sf-with-ul-pre">School Search</a></li>
                        <!-- 5th Menu [button] -->
                        <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu <?php echo $class_Immi; ?>"><a href="./../en/search-immigration.php" class="sf-with-ul-pre">Immi. Search</a></li>
                        <!-- 6th Menu [button] -->
                        <li class="menu-item menu-item-home menu-item-has-children kingster-normal-menu <?php echo $class_Fees; ?>"><a href="./../en/search-fees.php" class="sf-with-ul-pre">Fees Search</a></li>
                        <!-- 7th Menu [button] -->
                        <li class="menu-item menu-item-has-children kingster-normal-menu <?php echo $class_ausInfo; ?>"><a href="#" class="sf-with-ul-pre">Aus. Info</a>
                            <ul class="sub-menu">
