...
$sql_course = "SELECT `id`,`name`,IFNULL(name_en,`name`) AS `name_en`,`level_id`,`field_id_p`,`field_id_c`,`hours`,`months`,`fees` FROM course WHERE inst_id=? AND `status` > 0 AND is_valid = 1 ORDER BY id;";
