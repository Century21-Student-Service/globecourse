						...
						<div class="kingster-page-title-container kingster-container">
							<div class="kingster-page-title-content kingster-item-pdlr ctm-header__content"
								...
								<a href="school-info.php?id=<?php echo ($Sch['id']); ?>"><img class="animated fadeIn ctm-header__logo"
										src="./../<?php echo ($Sch['picurl']); ?>" width="" height="" style="border-radius: 10px;" loading="lazy"
										title="院校 - <?php echo ($Sch['title']); ?>" /></a> <!-- [Logo] -->
									...
									<div class="course-widget-price" style="float: none !important; margin-right: 0;">
										...
										<ul>
											...
											<li>
												...
												<span class="time"><?php echo ($row['ks']); ?> 周<?php echo $cDuration_yr; ?></span>
											</li>
											<li>
												<i class="fa fa-file-pdf-o" aria-hidden="true"></i>
												<span><b>课程类别</b></span>
												<span class="time"><?php echo (getCType($row['type'])); ?></span>
											</li>
											<li>
												<i class="fa fa-university" aria-hidden="true"></i>
												<span><b>院校名称</b></span>
												<span class="time"><?php echo ($Sch['title']); ?></span>
											</li>
											<!-- <li>
										...
										<a class="flat-button bg-orange custom-button_noBorder" style="color: white; font-weight: bold;"
											href="http://www.ct21.com.cn/online/online.php?zy=<?php echo urlencode(($newsTit)); ?>&sx=<?php echo urlencode(($Sch['title'])); ?>">申请课程</a>
									</div>
