...
<body class="home page-template-default page page-id-2039 gdlr-core-body woocommerce-no-js tribe-no-js kingster-body kingster-body-front kingster-full  kingster-with-sticky-navigation  kingster-blockquote-style-1 gdlr-core-link-to-lightbox">
						                    ...
						                    <div class="tab _inliner">
						                    	...
						                    	<div style="padding: 20px 5px;">
						                    		<div class="gdlr-core-column-60 tabContent" id="tab_1">
								                    	...
								                    	<div style="padding-bottom: 20px;"><span><strong>请选择您的「最高学历」或「目前就读年级」：</strong></span></div>
							                    ...
							                    <div style="padding: 20px 5px;">
							                    	<div class="gdlr-core-column-60 tabContent" style="display: none;" id="tab_2">
								                    	...
								                    	<div style="padding-bottom: 20px;"><span><strong>根据您的学历，我们为您推荐以下几项留学方案：</strong></span></div>
							                    		<div class="gdlr-core-pbf-element ctm-contentWrap">
			                                                <div class="gdlr-core-icon-list-item gdlr-core-item-pdlr gdlr-core-item-pdb clearfix ">
							                    ...
							                    <!-- ====================     << 所在州 >>     ==================== -->
							                    <div class="wrapMap">
							                    	<div class="gdlr-core-column-60 tabContent" style="display: none;" id="tab_3">

								                    	<div style="padding-bottom: 20px;"><span><strong>请点击澳洲地图中具体州的位置，以快速查询位于此州内的院校：</strong></span></div>
    ...
    <script type="text/javascript">
    	...
    	function getCType(){
    		...
    		jQuery.ajax({
				type :'GET',
				url  :'./../ext/ajaxFun.php?act=getStudySolution_cType&sType='+solutionID,
				date :'',
				success:function(m){
    	...
    	function getSchoolAll(){
    		...
    		jQuery.ajax({
				type :'GET',
				url  :'./../ext/ajaxFun.php?act=getStudySolution_schoolAll&cTypeAll='+cTypeAll+'&width='+w,
				date :'',
				success:function(m){
					jQuery('#list_School h4').remove();
					jQuery('#list_School div').remove();
